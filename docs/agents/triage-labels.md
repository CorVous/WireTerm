...
When a skill mentions a triage role, use the corresponding label string from this table. Edit the right-hand column if the repository's vocabulary changes.
